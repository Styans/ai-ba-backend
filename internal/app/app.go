...
func Run() error {
	...
	// Seed Admin
	_, err = authService.CreateUser("alixan.mustafaev@mail.ru", "123321", "Alihan (Admin)", "Business Analyst")
	if err != nil {
	...
	app := router.NewRouter(authService, llmService, msgRepo, sessRepo, draftRepo, teamMsgRepo, userRepo, hub, cfg.JWTSecret)
